...
namespace frmTitles
{
    public partial class Verb : Form
    {
        ...
        private void Verb_Load(object sender, EventArgs e)
        {
            ...
            TokenWordCommand = new OleDbCommand("Select * from Verb", conn);
            ...
            textWord.DataBindings.Add("Text", TokenWordTable, "VerbDesc");
            textTag.DataBindings.Add("Text", TokenWordTable, "Synonym");
            textInfo.DataBindings.Add("Text", TokenWordTable, "Language");
