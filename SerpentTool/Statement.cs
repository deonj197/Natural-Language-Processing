...
namespace frmTitles
{
    public partial class Statement : Form
    {
        ...
        private void Statement_Load(object sender, EventArgs e)
        {
            ...
            TokenWordCommand = new OleDbCommand("Select * from Statement", conn);
            ...
            textWord.DataBindings.Add("Text", TokenWordTable, "Source");
            textTag.DataBindings.Add("Text", TokenWordTable, "Subject");
            textInfo.DataBindings.Add("Text", TokenWordTable, "Action");
            ObjectTextbox.DataBindings.Add("Text", TokenWordTable, "Object");
