...
namespace frmTitles
{
    public partial class SynonymNoun : Form
    {//Connection Object
        ...
        private void SynonymNoun_Load(object sender, EventArgs e)
        {
            ...
            TokenWordCommand = new OleDbCommand("Select * from SynonymNoun", conn);
            ...
            textWord.DataBindings.Add("Text", TokenWordTable, "essence");
