...
namespace frmTitles
{
    ...
    public partial class Noun : Form
    {
        ...
        private void Noun_Load(object sender, EventArgs e)
        {
            ...
            textDescription.DataBindings.Add("Text", TokenWordTable, "NounDesc");
            checkPronoun.DataBindings.Add("Checked", TokenWordTable, "Pronoun");
            textSynonym.DataBindings.Add("Text", TokenWordTable, "Synonym");
            TextLanguage.DataBindings.Add("Text", TokenWordTable, "Language");
